...
![Opening VS Code](img/B-VS_Code-1.png){#fig-vscodesetup-a width="50%"}

![Opening a Terminal in VS Code](img/B-VS_Code-2.png){#fig-vscodesetup-b width="50%"}

![Install uv](img/B-VS_Code-3.png){#fig-vscodesetup-c width="50%"}

![Install Python](img/B-VS_Code-4.png){#fig-vscodesetup-d width="50%"}
